...
CREATE TABLE `egresso` (
  `id_egresso` int(11) NOT NULL AUTO_INCREMENT,
  `eg_dta_importe` date DEFAULT NULL,
  `id_curso` int(11) DEFAULT NULL,
  `eg_ano` int(11) DEFAULT NULL,
  `eg_fase` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_egresso`)
...
INSERT INTO `egresso` VALUES (1,'2017-06-19',1,2017,5);
